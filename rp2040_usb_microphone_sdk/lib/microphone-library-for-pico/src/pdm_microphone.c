...
// Custom bandpass settings
void pdm_microphone_set_filter_lowpass_hz(float lp_hz) {
    pdm_mic.filter.LP_HZ = lp_hz;
}
void pdm_microphone_set_filter_highpass_hz(float hp_hz) {
    pdm_mic.filter.HP_HZ = hp_hz;
}
